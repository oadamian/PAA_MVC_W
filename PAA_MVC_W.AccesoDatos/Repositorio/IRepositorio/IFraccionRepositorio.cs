...
{
    public interface IFraccionRepositorio : IRepositorio<Fraccion>
    {
        //se pone el metodo actualizar por cada uno de los repositorios individuales por tener su propias caracteristicas

        void Actualizar(Fraccion fraccion);

        IEnumerable<SelectListItem> ObtenerTodosArticulos(string obj);

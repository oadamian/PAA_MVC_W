...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        ...
        "ajax": {
            "url": "/Admin/Articulo/ObtenerTodos"
        },
        "columns": [
            { "data": "num", "width": "10%" },
            { "data": "bis", "width": "10%" },
            ...
            { "data": "direccionGeneral.siglas", "width": "10%" },
            {
                "data": "estado",
            ...
            },
            {
                ...
                "render": function (data) {
                    ...
                    <div class="text-center">
                       <a href="/Admin/Articulo/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                           <i class="bi bi-pencil-square"></i>
                       </a>
                       <a onclick=Delete("/Admin/Articulo/Delete/${data}") class="btn btn-danger text-white style="cursos:pointer">

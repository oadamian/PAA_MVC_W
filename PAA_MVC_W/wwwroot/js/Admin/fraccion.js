...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        ...
        "ajax": {
            "url": "/Admin/Fraccion/ObtenerTodos"
        },
        "columns": [
            { "data": "frac", "width": "10%" },
            { "data": "bis", "width": "10%" },
            { "data": "descripcion", "width": "40%" },
            { "data": "articulo.num", "width": "10%" },
            {
                "data": "estado",
            ...
            },
            {
                ...
                "render": function (data) {
                    ...
                    <div class="text-center">
                       <a href="/Admin/Fraccion/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                           <i class="bi bi-pencil-square"></i>
                       </a>
                       <a onclick=Delete("/Admin/Fraccion/Delete/${data}") class="btn btn-danger text-white style="cursos:pointer">
